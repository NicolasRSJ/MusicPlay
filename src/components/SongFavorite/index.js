...
import ButtonRemoveFavorites from "components/ButtonRemoveFavorites";


const SongFavorite = ({ song, artist = true }) => {
      ...
      <Flex justify="space-between">
        ...
        >
          ...
          <Box display="flex" gap="2" alignItems="center" flex="1" mb="1">
            ...
            <ButtonRemoveFavorites song={song} />
...
export default React.memo(SongFavorite);